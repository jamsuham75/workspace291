    ...
    function(inputId, inputpw, done){
        ...
        .then((result)=>{
            if(result.userpw == sha(inputpw)){
                ...
                done(null, false, {message : "비밀번호가 틀렸어요."});
            }
        })
    }
))
...
passport.use(new FacebookStrategy(
    {
        clientID : '892446833014714',
        clientSecret : 'aeaf694406686c285933281b590c84d1',
...
//     mydb.collection("login").findOne({ id: puserid }, function (err, result) {
//         console.log(puserid);
//         done(null, result);
//       });
//   });
